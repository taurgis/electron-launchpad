...
import PasswordInput from '../../../src/renderer/components/form/passwordinput'
...
function setupStandard() {
    const renderer = ReactTestRenderer.create(<PasswordInput className='testClass' id='testid' name='testname' value='testvalue' placeholder='testplaceholder' onChange={onChangeTest} />);
...
describe('Collection component', () => {
    ...
    it('first child should be of type email', () => {
        const { component } = setupStandard();
        expect(component.children[0].props.type).toBe('password');
    });
