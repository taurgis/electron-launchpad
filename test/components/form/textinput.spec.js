...
import TextInput from '../../../src/renderer/components/form/textinput'
...
function setupStandard() {
    const renderer = ReactTestRenderer.create(<TextInput className='testClass' id='testid' name='testname' value='testvalue' placeholder='testplaceholder' onChange={onChangeTest} />);
...
describe('Collection component', () => {
    ...
    it('first child should be of type text', () => {
        const { component } = setupStandard();
        expect(component.children[0].props.type).toBe('text');
    });
